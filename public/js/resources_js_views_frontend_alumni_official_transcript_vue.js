...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    checkStatus: function checkStatus() {
      ...
      this.axios.post('/api/user/checkStatus', this.status).then(function (_ref) {
        var data = _ref.data;
  ...
  mounted: function mounted() {
    ...
    this.axios.get('/api/user/getAnnouncements').then(function (_ref3) {
      var data = _ref3.data;
      _this4.anouncements = data;
    })["catch"]();
    this.axios.get('/api/user/acadamic_years').then(function (_ref4) {
      var data = _ref4.data;
      _this4.acadamic_years = data;
    })["catch"]();
    this.axios.get('/api/user/colleges').then(function (_ref5) {
      var data = _ref5.data;
      _this4.colleges = data;
    })["catch"]();
    this.axios.get('/api/user/study_levels').then(function (_ref6) {
      var data = _ref6.data;
      _this4.study_levels = data;
    })["catch"]();
    this.axios.get('/api/user/admission_types').then(function (_ref7) {
      var data = _ref7.data;
      _this4.admission_types = data;
    })["catch"]();
    this.axios.get('/api/user/departements').then(function (_ref8) {
      var data = _ref8.data;
      _this4.departements = data;
    })["catch"]();
    this.axios.get('/api/user/semisters').then(function (_ref9) {
      var data = _ref9.data;
      _this4.semisters = data;
    })["catch"]();
  }
});
