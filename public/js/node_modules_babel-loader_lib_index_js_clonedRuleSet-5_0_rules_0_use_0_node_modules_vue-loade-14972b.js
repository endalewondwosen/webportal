"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["node_modules_babel-loader_lib_index_js_clonedRuleSet-5_0_rules_0_use_0_node_modules_vue-loade-14972b"],{
...
/* harmony export */ });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! . */ "./resources/js/views/user_profile/index.vue");
//
//
//
//
  ...
  methods: {
    updateProfile: function updateProfile() {
      ...
      this.axios.patch('/api/user/updateProfile/' + id, this.form).then(function () {
        ...
        ___WEBPACK_IMPORTED_MODULE_0__["default"].logout(); //reset local storage

        _this.$router.push('/');

        Toast.fire({
          icon: "success",
          title: "Your Profile Updated Succeefully "
        });
