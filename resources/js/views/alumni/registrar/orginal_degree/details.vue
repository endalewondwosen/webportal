                            ...
                            <div v-for="(applicant,index) in applicants"  :key="index+2" class="tab-pane fade profile-overview pt-3" id="profile-settings">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">
                                        <div v-if="applicant.bank_receipt" class="col-lg-9 col-md-8">   <button @click="downladOrginalBankStatement(applicant.id,applicant.bank_receipt)" class="btn btn-info"><i class="bx bxs-download"></i></button>
                                    </div>
                                    <p v-else>No File </p>
                                    </div>
                                </div>
...
export default {
    created() {
        ...
        this.axios.get('/api/user/getSingleOrginalApplicant/' + id)
            .then(({
                data
            }) => {
    ...
    methods:{
    downladOrginalBankStatement(id,file){
        this.axios({
