            ...
            <div class="col-xl-12">
                ...
                <div class="card">
                    <div class="card-body pt-3">
                        <!-- Bordered Tabs -->
                          <router-link to="/home/registrar_orginal_degree_view" class="btn btn-primary" style="float:right"> Back</router-link>
                            ...
                            <div v-for="(applicant,index) in applicants"  :key="index+2" class="tab-pane fade profile-overview pt-3" id="profile-settings">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">  
                                        <div v-if="applicant.bank_receipt" class="col-lg-9 col-md-8">   <button @click="downlabankreciept(applicant.id,applicant.bank_receipt)" class="btn btn-info"><i class="bx bxs-download"></i></button>
                                    </div>
                                    <p v-else>No File </p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">
                                        ...
                                        <div v-if="applicant.cost_sharing_letter" class="col-lg-9 col-md-8">   <button @click="downladCostSharingLetter(applicant.id,applicant.cost_sharing_letter)" class="btn btn-info"><i class="bx bxs-download"></i></button>
                                    </div>
                                    <p v-else>No File </p></div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Service Type</div>
                                    <div class="col-lg-9 col-md-8">{{ applicant.service_type }}</div>
                                </div>
                                   <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Bank Deposit Tr. Ref.</div>
                                    <div class="col-lg-9 col-md-8">{{ applicant.bank_tr_ref }}</div>
                                </div>
                                  <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Other Documents</div>
                                    <div class="col-lg-9 col-md-8">    <div v-if="applicant.cost_sharing_letter" class="col-lg-9 col-md-8">   <button @click="downladCostSharingLetter(applicant.id,applicant.cost_sharing_letter)" class="btn btn-info"><i class="bx bxs-download"></i></button>
                                    </div>
                                    <p v-else>No File </p>
...
export default {
    created() {
        ...
        this.axios.get('/api/user/getSingleStudentCopyApplicant/' + id)
            .then(({
                data
            }) => {
    ...
    downladCostSharingLetter(id,file){
        this.axios({
