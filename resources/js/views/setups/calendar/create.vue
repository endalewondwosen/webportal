<template>
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Add Calender
                                <router-link to="/home/all-calendar" class="btn btn-primary" style="float:right"> All Calendar</router-link>

                            </h5>
                            <form class="row g-3 justify-content-center" @submit.prevent="addCalendar">
                                <div class="col-md-8">
    ...
    export default {
        ...
        methods: {
            addCalendar() {
                this.axios.post('/api/user/create-calendar', this.form)
                    .then(({
                        data
                    }) => {
