    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Add Announcement
                            <router-link to="/home/all-announcement" class="btn btn-primary" style="float:right"> All Announcement</router-link>
...
export default {
    ...
    methods: {
        addAnnouncement() {
            this.axios.post('/api/user/announcements/'+this.auth.user.id, this.form)
                .then(({
                    data
                }) => {
