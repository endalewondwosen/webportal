              ...
              <div class="tab-content pt-2" id="myTabjustifiedContent">
                ...
                >
                  <strong class="text-danger"
                    >There is no instruction yet!!</strong
                  >
                </div>
                ...
                >
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="card">
                        <div class="card-body">
                          <h5 class="card-title">Orginal Degree</h5>
                          ...
                          <div>
                            ...
                            >
                              ...
                              <div class="col-md-4">
                                ...
                                <div
                                  class="text-danger"
                                  v-if="errors.year_of_graduation"
                                >
                              ...
                              <div class="col-md-4">
                                ...
                                >
                                  ...
                                  <option value="Orginal Degree">
                                    Orginal Degree
                                  </option>
                                  <option value="Orginal Degree Replacement">
                              ...
                              <div class="col-md-4">
                                <label
                                  ...
                                  class="form-label text-danger"
                                >
                                  <b>Attach Cost sharing letter</b>
                                </label>
                                <input
                                  type="file"
                ...
                >
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="card">
                        <div class="card-body">
                          <h5 class="card-title">Orginal Degree Status</h5>
...
export default {
  ...
  methods: {
    checkStatus() {
      this.axios
        .post("/api/user/checkOrginalStatus", this.status)
        .then(({ data }) => {
          if (data == 2) {
    ...
    sendOfficialTranscript() {
      ...
      this.axios
        .post("/api/user/orginal_degree", fd)
        .then(() => {
          this.$router.push("/");
          Toast.fire({
            icon: "success",
